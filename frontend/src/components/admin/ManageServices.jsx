...
export default function ManageServices() {
  ...
  const openEditModal = (service) => {
    ...
    setFormData({
      ...
      options: service.options.length > 0 ? service.options : [{ btuRange: "", price: "", unit: "per_unit" }],
    })
  ...
  const addOption = () => {
    setFormData({
      ...formData,
      options: [...formData.options, { btuRange: "", price: "", unit: "per_unit" }],
    })
  }
    ...
    <div>
      ...
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-sm text-gray-600 mt-1">มีบริการทั้งหมด {services.length} รายการ</p>
        </div>
        <button
          onClick={() => {
            resetForm()
      ...
      {services.length === 0 ? (
        <div className="bg-white rounded-lg shadow-sm border p-12 text-center">
          ...
          <h3 className="text-lg font-medium text-gray-900 mb-2">ยังไม่มีบริการ</h3>
          ...
          {services.map((service) => (
            <div key={service._id} className="bg-white rounded-lg shadow-sm border p-6">
              ...
              {service.options && service.options.length > 0 && (
                <div className="mt-4">
                  <p className="text-sm font-medium text-gray-700 mb-2">ตัวเลือกราคา:</p>
                  <div className="space-y-2">
                    {service.options.map((option, index) => (
                      <div key={index} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                        <div>
                          <span className="text-sm font-medium text-gray-900">{option.btuRange}</span>
                        </div>
      ...
      {showAddModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4 overflow-y-auto">
          <div className="bg-white rounded-lg max-w-2xl w-full p-6 my-8">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">เพิ่มบริการใหม่</h3>
              ...
              <div className="space-y-4">
                ...
                <div>
                  <div className="flex justify-between items-center mb-2">
                    <label className="block text-sm font-medium text-gray-700">ตัวเลือกราคา</label>
                    <button
                      type="button"
                      onClick={addOption}
                      ...
                      <div key={index} className="flex gap-2 items-start p-3 bg-gray-50 rounded-lg">
                        <div className="flex-1 grid grid-cols-3 gap-2">
                          <input
                            ...
                            onChange={(e) => updateOption(index, "btuRange", e.target.value)}
